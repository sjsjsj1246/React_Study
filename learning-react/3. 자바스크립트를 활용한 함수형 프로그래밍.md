...
여러분이 자신의 출생증명서를 공개하고 싶은데 개인 정보는 알아볼 수 없게 만들거나 없애고 싶다면 실질적으로 선택할 수 있는 방법은 두 가지 뿐이다. 첫 번째 방법은 원본 출생증명서의 개인 정보를 유성펜으로 가리는 것이고, 두 번째 방법은 출생증명서의 복사본을 만든다음 복사본의 개인 정보를 유성펜으로 가리는 것이다. 물론 두 번째 방법이 더 바람직하다. 두 번째 방법을 선택하면 개인 정보를 보호하면서 출생증명을 공개하는 동시에 원본을 안전하게 유지할 수 있다.  
